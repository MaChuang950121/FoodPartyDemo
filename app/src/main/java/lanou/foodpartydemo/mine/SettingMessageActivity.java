...
public class SettingMessageActivity extends BaseActivity  implements View.OnClickListener{
    ...
    private static final String TAG = SettingMessageActivity.class.getSimpleName();
    ...
    protected void initData() {
        ...
        heightPop();
        weightPop();
        setOnClick(this,setSex,setAge,setHeight,setWeight,back);
    }
    ...
    protected void initViews() {
        ...
        userIcon = bindView(R.id.setting_user_icon);
        userName = bindView(R.id.setting_user_name);
...
//                }
                initPop.showAtLocation(SettingMessageActivity.this.findViewById(R.id.personagemes)
                        , Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, 0);
                break;
            case R.id.personagemessage_age:
                initAgePop.showAtLocation(SettingMessageActivity.this.findViewById(R.id.personagemes)
                        , Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, 0);
                break;
            case R.id.personagemessage_height:
                initHeightPop.showAtLocation(SettingMessageActivity.this.findViewById(R.id.personagemes)
                        , Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, 0);
                break;
            case R.id.personagemessage_weight:
                initWeightPop.showAtLocation(SettingMessageActivity.this.findViewById(R.id.personagemes)
                        , Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, 0);
                break;
